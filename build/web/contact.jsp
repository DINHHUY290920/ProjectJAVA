    ...
    <body>
        ...
        <div id="header" style="width: 1000px; height: 100px; margin: 0 auto; background-color:#FFFFFF; border: none solid #8C0209;">
            <div>
                <h1 style="float:left; margin-left:15px; font-size:40px;">
                    <span style=""><a href="home" style="text-decoration: none;color:#DAA520">Bakery </a> </span><span style=""><a href="home" style="text-decoration: none;color:#000000">Store</a></span>
                </h1>
        ...
        <section id="menuContaniner">
            <ul class="main_nav">
                ...
                <li ><a  href="alloder">All Oder</a></li>
                 <%} else {%>
                <li ><a  href="about" >About</a></li>
                <li ><a  href="shop" style="color:green;">Shop</a></li>
        ...
        <section id="mainContainer">
            <div class="about" >
                ...
                <div style="margin-top:-20px;font-size:30px;color:#556B2F;">+84 38 630 6594    |    huyndhe140089@fpt.edu.vn  </div>
                <div style="margin-top:20px;font-family:Candara;padding-left:210px;width:800px;font-size:20px;color:#556B2F;line-height:2em;">
                    Pick up is available at FPT University Hoa Lac<br> 
                    Ha Noi, Viet Nam
                </div>
        ...
        <div id="footer" style="height: 250px; margin: 0 auto;padding: 0 20px;
            ...
            <p style="float:left; margin:70px; font-size:60px;"> <span style="color:#DAA520">Bakery </span><span style="color:#000000">Store</span>
            </p>

            <p style="float:left;margin-top:170px;margin-left:-350px;">
                <a href="https://www.facebook.com/profile.php?id=100013231893863"><img src="src/ins.png" style="width:65px; height:65px;"></img>
                    <a href="https://www.facebook.com/profile.php?id=100013231893863"><img src="src/fb.png" style="width:65px; height:65px;"></img>

                        </p>

                        <p style="float:right;margin:40px;text-align:left;font-size:15px;margin-right:190px;">
                            <b>Our Story</b><br /><br />
                            <span style="color:#556B2F;">Bakery Store is a Hanoi-based bakeshop, which is <br/>
